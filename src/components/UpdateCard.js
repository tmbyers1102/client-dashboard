    ...
    return (
        <div class="flex relative pt-0 pb-8 sm:items-center md:w-2/3 lg:w-full mx-auto">
            ...
            <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                <div class="flex-shrink-0 w-20 h-20 bg-blue-100 text-blue-700 rounded-full inline-flex items-center justify-center">
                ...
                <div class="container">
                    <div class="flex flex-wrap items-center h-full">
                        ...
                        <div class="w-1/3 min-w-fit sm:pl-6 mb-6 sm:mt-0">
                            <UpdateScreenshot />
                        </div>
                    </div>
                </div>
